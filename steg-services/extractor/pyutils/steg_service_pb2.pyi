...
class StegServiceRequest(_message.Message):
    __slots__ = ("file", "function", "params")
    ...
    def __init__(self, file: _Optional[bytes] = ..., function: _Optional[str] = ..., params: _Optional[_Mapping[str, StegServiceRequestParameterValue]] = ...) -> None: ...
...
class StegServiceResponseValue(_message.Message):
...
class StegServiceResponse(_message.Message):
    ...
    class ValuesEntry(_message.Message):
        ...
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: str
        value: StegServiceResponseValue
        def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[StegServiceResponseValue, _Mapping]] = ...) -> None: ...
    VALUES_FIELD_NUMBER: _ClassVar[int]
    ERROR_FIELD_NUMBER: _ClassVar[int]
    values: _containers.MessageMap[str, StegServiceResponseValue]
    error: str
    def __init__(self, values: _Optional[_Mapping[str, StegServiceResponseValue]] = ..., error: _Optional[str] = ...) -> None: ...
...
class StegServiceFunction(_message.Message):
    __slots__ = ("name", "description", "parameter", "return_fields", "supported_file_types")
    NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., parameter: _Optional[_Iterable[_Union[StegServiceParameterDefinition, _Mapping]]] = ..., return_fields: _Optional[_Iterable[_Union[StegServiceReturnFieldDefinition, _Mapping]]] = ..., supported_file_types: _Optional[_Iterable[str]] = ...) -> None: ...
